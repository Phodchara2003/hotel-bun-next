...
export const userProfileRoutes = new Elysia({ prefix: '' })
  
  // Get user profile (for all user types)
  ...
  // Update user profile (for all user types)
  ...
  // Change password (for all user types)
  .post('/change-password', async ({ body, headers, set }) => {
    try {
      console.log('🔒 POST /change-password - Change user password');
