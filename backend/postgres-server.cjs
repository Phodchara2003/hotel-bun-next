...
async function connectToDatabase() {
  try {
    ...
    // Don't exit, continue with mock data for now
...
async function getHotels() {
  try {
    ...
    return [
      {
        id: 1,
        name: 'Sample Hotel Bangkok',
        description: 'Beautiful hotel in Bangkok from database',
    ...
    return [
      {
        ...
        type: 'standard',
        hotel_name: 'Sample Hotel Bangkok'
      }
    ];
  }
}
