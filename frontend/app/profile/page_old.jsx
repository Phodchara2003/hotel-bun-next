...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    if (user) {
      setProfileData({
        ...
        nationalId: '' // เริ่มต้นเป็นช่องว่างเสมอ ให้ user กรอกใหม่
      });
    }
  ...
  const validateProfileForm = () => {
    ...
    // Validate National ID (Thai ID format: 14 digits) - Required field
            ...
            {activeTab === 'profile' && (
              <div className="bg-white rounded-lg shadow">
                ...
                <form onSubmit={handleProfileUpdate} className="p-6 space-y-6">
                  ...
                  {/* National ID Field */}
                  <div>
                    <label htmlFor="nationalId" className="block text-sm font-medium text-gray-900 mb-2">
                      <User className="h-4 w-4 inline mr-1" />
