...
export default function CreatePaymentPage() {
  ...
  const handlePaymentConfirm = async () => {
    ...
    try {
      ...
      // ไปหน้าการจองสำเร็จพร้อมข้อมูลรายละเอียด
      setTimeout(() => {
                ...
                <div className="space-y-6">
                  ...
                  {paymentSettings.data.qrCodeUrl && (
                    <div className="text-center bg-green-50 rounded-lg p-8 border-2 border-green-200">
                      ...
                      <p className="text-green-600 font-bold text-xl mt-2">จำนวน: ฿{bookingData?.total_price?.toLocaleString()}</p>
                    </div>
                  )}
