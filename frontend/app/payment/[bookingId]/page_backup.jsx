            ...
            {paymentStep === 'payment' && (
              <>
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                  ...
                  {/* Payment Amount */}
                  <div className="mb-6 p-4 bg-gradient-to-r from-primary-600 to-primary-700 rounded-lg border border-primary-500 shadow-lg">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div className="bg-white rounded-lg p-3 border border-blue-200 shadow-sm">
                          ...
                          <span className="text-blue-800 font-semibold">{paymentSettings.data.bankName}</span>
                        </div>
                        <div className="bg-white rounded-lg p-3 border border-green-200 shadow-sm">
                          <span className="block text-gray-600 text-xs mb-1">เลขที่บัญชี</span>
                          <span className="text-green-800 font-mono font-semibold">{paymentSettings.data.bankAccount}</span>
                        </div>
                        <div className="bg-white rounded-lg p-3 border border-orange-200 shadow-sm">
                          ...
                          <span className="text-orange-800 font-semibold">{paymentSettings.data.accountName}</span>
                        </div>
                      </div>
                      {paymentSettings.data.phoneNumber && (
                        <div className="mt-4 pt-3 border-t border-blue-200">
                          <div className="bg-white rounded-lg p-3 border border-purple-200 shadow-sm text-center">
                            <span className="block text-gray-600 text-xs mb-1">PromptPay</span>
                            <span className="text-purple-800 font-mono font-semibold text-lg">{paymentSettings.data.phoneNumber}</span>
                          </div>
                        </div>
                      )}
                    </div>
                  ...
                  {paymentSettings?.data.qrCodeUrl && (
                    <div className="text-center mb-6">
                      ...
                      <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-200 inline-block">
                        <img 
