...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* เมนูไปหน้าจัดการข้อมูลติดต่อโรงแรม */}
        {/* เมนูไปหน้าจัดการข้อมูลติดต่อโรงแรม */}
        <div className="mt-8 flex flex-col items-center">
          <Link href="/admin/contact-settings" className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition-colors">
            <Phone className="mr-2" />
            จัดการข้อมูลติดต่อโรงแรม
          </Link>
        </div>
      </div>
    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div className="border rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">จัดการข้อมูลติดต่อที่แสดงในเว็บไซต์</p>
          <Link 
