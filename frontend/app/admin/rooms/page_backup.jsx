                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-4 mt-2 text-sm text-neutral-600 dark:text-neutral-400">
                            <span className="flex items-center gap-1">
                              ...
                              {formatPrice(room.price_per_night)}/คืน สำหรับ {room.max_guests || room.max_occupancy || 1} คน
                            </span>
                            <span className="flex items-center gap-1">
                              {room.sub_rooms && (
                                <>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-neutral-900 dark:text-white">
                        {formatPrice(selectedRoom?.price_per_night || selectedRoom?.price || 1500)}/คืน สำหรับ {selectedRoom?.max_guests || selectedRoom?.capacity || '2'} คน
                      </p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
